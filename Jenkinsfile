pipeline {
    ...
    stages {
        ...
        stage('Create PVC') {
            steps {
                 script {
                     withKubeConfig(caCertificate: '', clusterName: 'devops-cluster', contextName: '', credentialsId: 'k1-token', namespace: 'webapps', restrictKubeConfigAccess: false, serverUrl: 'https://4703F73AC119377B7570250D7C61892E.gr7.us-east-1.eks.amazonaws.com') {
                              sh '''
